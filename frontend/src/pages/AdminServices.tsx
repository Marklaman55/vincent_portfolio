...
import { getServicesList as fetchServices, saveService, deleteService } from "../api/services";
...
const AdminServices = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const dataToSave = editingService ? { ...formData, id: editingService.id } : formData;
