      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center mb-12 gap-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-ink/60 font-mono text-[10px] tracking-widest uppercase">Web Hub Solutions Control Center</p>
            </div>
          </div>
        ...
        <AnimatePresence mode="wait">
          {showAddForm ? (
            ...
            >
              <h2 className="text-2xl font-display font-bold text-ink mb-8">{editingProject ? 'Edit Project' : 'Project Details'}</h2>
              <form onSubmit={handleSubmitProject} className="space-y-6">
                ...
                >
                  {isSubmitting ? (
                    ...
                    <>
                      <Save className="w-6 h-6" /> {editingProject ? 'Update Project' : 'Save Project'}
                    </>
                  )}
                </button>
              </form>
                    ...
                    <div className="aspect-video relative overflow-hidden">
                       ...
                       <div className="absolute top-4 right-4 flex gap-2">
                          ...
                          <button 
                            ...
                            className="w-10 h-10 bg-white/90 rounded-full flex items-center justify-center text-ink hover:text-primary transition-colors"
                          >
                            <Plus size={18} className="rotate-45" /> {/* Using Plus as a placeholder for edit if needed or just use a custom icon */}
                          </button>
                          <button 
