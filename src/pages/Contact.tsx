...
const Contact = () => {
  ...
  return (
    <div className="pt-32 pb-24">
      <SEO 
        title="Contact Us" 
        description="Get in touch with Web Hub. We are ready to build your next extraordinary digital product. Contact us for web development, e-commerce, and trading systems in Kenya."
        keywords="contact web hub, tech agency contact nairobi, hire web developers kenya"
      />
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div>
            ...
            >
              Ready to build something extraordinary? Reach out to Web Hub today. 
              Fill out the form and we'll respond via secure transmission.
            </motion.p>
            ...
            <div className="space-y-8">
              <div className="flex items-start space-x-6">
                ...
                <div>
                  ...
                  <p className="text-ink/60">webhubsolutionhs@gmail.com</p>
                </div>
              </div>
              <div className="flex items-start space-x-6">
                <div className="w-12 h-12 rounded-xl bg-tech-gradient flex items-center justify-center text-white shadow-lg shadow-primary/20 shrink-0">
              ...
              <div className="flex items-start space-x-6">
                ...
                <div>
                  ...
                  <p className="text-ink/60">Nairobi, Kenya<br />Innovation District</p>
                </div>
              </div>
            </div>
          </div>
