...
const services = [
  {
    ...
    description: "Custom, high-performance websites built with React, Next.js, and modern tech stacks. We focus on speed, SEO, and user experience.",
    features: ["Responsive Design", "SEO Optimization", "Fast Loading", "Custom CMS"]
  },
  {
    icon: <ShoppingCart className="w-10 h-10" />,
    name: "E-commerce Development",
    description: "Scalable online stores that convert. We build custom e-commerce solutions or integrate with Shopify and WooCommerce.",
