        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-ink/60 max-w-md mb-8">
              ...
              From high-performance web applications to advanced network systems, we define the next era of technology.
              Proudly serving the Kenyan digital landscape.
            </p>
            <div className="flex flex-wrap gap-4 sm:gap-5">
              <a href="https://facebook.com/webhub" target="_blank" rel="noopener noreferrer" className="p-3 glass rounded-xl hover:text-primary transition-all hover:scale-110 border-primary/10 shadow-sm" aria-label="Facebook">
