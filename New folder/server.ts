...
if (settingsCount.count === 0) {
  ...
  db.prepare("INSERT INTO settings (key, value) VALUES (?, ?)").run("company_email", "vincentkamau137@gmail.com");
} else {
  ...
  db.prepare("UPDATE settings SET value = ? WHERE key = 'company_email'").run("vincentkamau137@gmail.com");
}
